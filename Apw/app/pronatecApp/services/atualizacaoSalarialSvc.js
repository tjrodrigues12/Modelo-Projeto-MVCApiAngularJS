atualizacaoSalarialMdl.service('atualizacaoSalarialSvc', ['$http', 'globalSvc',
    function ($http, globalSvc){

        var urlBase = '/api/Pronatec/AtualizacaoSalarial/';

        //#region Pesquisar Profissional
        this.obterPesquisarProfissionaisGridDados = function (filtro) {
            return $http.get(urlBase + 'GetPesquisarProfissionaisGridDados', { params: filtro }).then(response => {
        ...
        //#region Pesquisar vinculos de trabalho Profissional
        this.obterDadosProfissional = function (usuarioId) {
            return $http.get(urlBase + 'GetDadosVinculosTrabalho', { params: { usuarioId: usuarioId } }).then(response => {
                return globalSvc.getResponse(response);
            }, response => {
                globalSvc.extrairMensagens(response);
            });
        ...
        this.obterAnoReferenciaParaPesquisarHolerite = function (pessoaTrabalhoId) {
            return $http.get(urlBase + 'GetObterAnoReferenciaParaPesquisarHolerite', { params: { pessoaTrabalhoId: pessoaTrabalhoId } }).then(response => {
                return globalSvc.getResponse(response);
            }, response => {
                globalSvc.extrairMensagens(response);
            });
