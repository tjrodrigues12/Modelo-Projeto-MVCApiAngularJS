atualizacaoSalarialMdl.controller('incluirHoleriteCtrl', ['$scope', 'atualizacaoSalarialSvc', 'globalSvc', 'ValidationService', 'Upload',
            ...
            if (validarExtensoesPermitidas(extensaoArquivo)) {
                if (file) {
                    $scope.loadUpload = Upload.upload({
                        url: '/api/Pronatec/AtualizacaoSalarial/UploadArquivo',
                        data: { file: file }
