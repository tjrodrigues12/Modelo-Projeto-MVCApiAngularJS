atualizacaoSalarialMdl.controller('pesquisarHoleriteCtrl', ['$scope', 'atualizacaoSalarialSvc', 'globalSvc', '$filter',
    function ($scope, service, globalSvc, $filter) {
        ...
        $scope.obterAnoReferencia = function () {
            $scope.loadAnoRef = service.obterAnoReferenciaParaPesquisarHolerite($scope.$parent.pessoaTrabalhoId).then(function (response) {
        ...
        $scope.incluirHolerite = function () {
            ...
            $scope.$parent.filtroDados = $scope.filtroDados;
        ...
        $scope.init = function () {
            ...
            if ($scope.$parent.filtroDados == undefined || $scope.$parent.filtroDados == null) {
                $scope.filtroDados = {
                    pessoaTrabalhoId: $scope.$parent.pessoaTrabalhoId
                };
            }
            else {
                $scope.filtroDados = $scope.$parent.filtroDados;
                $scope.obterPessoaTrabalhoHoleriteGridDados();
            }
