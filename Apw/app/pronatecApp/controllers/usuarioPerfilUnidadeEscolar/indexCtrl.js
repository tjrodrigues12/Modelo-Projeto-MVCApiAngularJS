usuarioPerfilUnidadeEscolarMdl.controller('indexCtrl', ['$scope', '$location',
    function ($scope, $location) {
        ...
        $scope.redirecionarPerfil = function () {
            return $location.path("/perfil");
        }

        $scope.redirecionarUnidadeEscolar = function () {
            return $location.path("/unidadeEscolar");
        }
